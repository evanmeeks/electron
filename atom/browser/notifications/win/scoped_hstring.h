...
#ifndef ATOM_BROWSER_NOTIFICATIONS_WIN_SCOPED_HSTRING_H_
#define ATOM_BROWSER_NOTIFICATIONS_WIN_SCOPED_HSTRING_H_
...
#endif  // ATOM_BROWSER_NOTIFICATIONS_WIN_SCOPED_HSTRING_H_
